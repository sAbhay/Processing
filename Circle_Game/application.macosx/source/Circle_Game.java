...
{ 
  ...
  if (screenState == 0)
  {
    ...
    textAlign(CENTER);
    textSize(144);
    text("Circle Game", width/2, height/3.6f);
...
class Player
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--hide-stop", "Circle_Game" };
    if (passedArgs != null) {
